...
<html>
    ...
    <body>
        <div class="container row">
            <form method="post" class="row form-horizontal">
                <div class="row form-group">
                    <fieldset><center>nouvelles ues</center></fieldset>
                </div>
                <div id="success" class="has-success" style="display: none">
                    Ue correctement ajoutée
                </div>
                <div id="error" class="has-error" style="display: none">
                    Un problème est survenu lors de la sauvegarde
                </div>
                <div class="row form-group">
                    <label class="control-label col-lg-3" for="code">Code de l'Ue</label>
                    <div class="col-lg-9">
                        <input type="text" name="code" id="code"  required="" class="form-control"/>
                    </div>
                </div><br>
                <div class="row form-group">
                    <label class="control-label col-lg-3" for="Libelle">Libellé de l'Ue</label>
                    <div class="col-lg-9">
                        <input type="text" name="libelle" id="libelle" required="" class="form-control"/>
                    </div>
                </div><br>
                <div class="row form-group">
                    <label class="control-label col-lg-3" for="semestre">Semestre</label> 
                    <div class="col-lg-9">
                        <select class="form-control" type="text" name="semestre" id="semestre"></select>
                    </div>
                </div><br>
        ...
        <script src="assets/js/groupe1/n_ue.js"></script>
    </body>
</html>
