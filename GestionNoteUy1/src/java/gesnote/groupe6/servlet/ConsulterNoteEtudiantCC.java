 ...
 * @author Colombo
 */
@WebServlet(name = "ConsulterNoteEtudiantCC", urlPatterns = {"/ConsulterNoteEtudiantCC"})
public class ConsulterNoteEtudiantCC extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //HttpSession session = request.getSession();
         ...
         // int id=(int) request.getAttribute("id");
           ...
           List<EtudiantExam> liste = cdd.findNote(matiereId,"cc");
