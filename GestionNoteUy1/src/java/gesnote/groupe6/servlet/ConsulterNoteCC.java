 ...
 * @author DELMAS
 */
@WebServlet(name = "ConsulterNoteCC", urlPatterns = {"/ConsulterNoteCC"})
public class ConsulterNoteCC extends HttpServlet {
    @EJB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/groupe7/Notes_Etudiants_Dpt.jsp")
