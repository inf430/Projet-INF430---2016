...
@WebServlet(name = "CreateUeServlet", urlPatterns = {"/createue"})
public class CreateUeServlet extends HttpServlet {
        ...
        if (session.getAttribute("login") != null) {
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    jsonobject.put("resultat", dao.ckeckExistUe(code)?1:0);
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                if (objetjson == null) {
                    ...
                    JSONObject jsonobject = (JSONObject) parametres.get(0);
                    JSONObject params = (JSONObject) jsonobject.getJSONObject("params");
                    semestre = params.getInt("semestre");
                    code = params.getString("code");
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.addUe(semestre, code, libelle) ? 1 : 0);
                PrintWriter writer = response.getWriter();
                writer.write(jsonobject.toString());
