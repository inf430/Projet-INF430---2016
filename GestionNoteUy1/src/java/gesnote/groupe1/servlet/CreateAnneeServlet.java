...
@WebServlet(name = "CreateAnneeServlet", urlPatterns = {"/createannee"})
public class CreateAnneeServlet extends HttpServlet {
        ...
        if (session.getAttribute("login") != null) {
            ...
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    jsonobject.put("resultat", dao.existAnnee(annee) ? 1 : 0);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.addYear(annee) ? 1 : 0);
