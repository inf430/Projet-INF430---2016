...
@WebServlet(name = "AddEtudiantClasseServlet", urlPatterns = {"/etudiantclasse"})
public class AddEtudiantClasseServlet extends HttpServlet {
            ...
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    if (objetjson == null) {
                        ...
                        etudiant = params.getString("matricule");
                        classe = params.getInt("classe");
                    } else {
                    ...
                    jsonobject.put("resultat", dao.checkEtudiantClasse(etudiant, classe) ? 1 : 0);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.associateEtudiantclasse(etudiant, classe) ? 1 : 0);
                PrintWriter writer = response.getWriter();
                writer.write(jsonobject.toString());
