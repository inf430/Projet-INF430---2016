...
@WebServlet(name = "CreateFiliereServlet", urlPatterns = {"/createfiliere"})
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                if (objetjson == null) {
                    ...
                    JSONObject jsonobject = (JSONObject) parametres.get(0);
                    JSONObject params = (JSONObject) jsonobject.getJSONObject("params");
                    departement = params.getInt("departement");
                    code = params.getString("code");
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.addFiliere(departement, code, libelle) ? 1 : 0);
                PrintWriter writer = response.getWriter();
                writer.write(jsonobject.toString());
