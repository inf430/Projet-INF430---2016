...
@WebServlet(urlPatterns = {"/addroleperson"})
public class AddRolePersonServlet extends HttpServlet {
        ...
        if (session.getAttribute("login") != null) {
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    jsonobject.put("resultat", dao.personHasRole(login, role) ? 1 : 0);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.associateRole(login, role) ? 1 : 0);
                PrintWriter writer = response.getWriter();
                writer.write(jsonobject.toString());
