...
@WebServlet(name = "CreateDepartementServlet", urlPatterns = {"/createdepartement"})
public class CreateDepartementServlet extends HttpServlet {
        ...
        if (session.getAttribute("login") != null) {
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    jsonobject.put("resultat", dao.checkDepartement(code) ? 1 : 0);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                JSONObject jsonobject = new JSONObject();
                jsonobject.put("resultat", dao.addDepartement(code, libelle) ? 1 : 0);
                PrintWriter writer = response.getWriter();
                writer.write(jsonobject.toString());
