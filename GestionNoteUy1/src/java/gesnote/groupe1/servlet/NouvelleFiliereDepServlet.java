...
@WebServlet(name = "NouvelleFiliereDepServlet", urlPatterns = {"/nouvellefilieredep"})
public class NouvelleFiliereDepServlet extends HttpServlet {
            ...
            if (request.getParameter("params") != null) {
                ...
                try {
                    ...
                    if (objetjson == null) {
                        ...
                        id_departement = params.getInt("iddep");
                    } else {
                    ...
                    jsonobject.put("resultat", dao.checkFiliere(code) ? 1 : 0);
                ...
                request.setAttribute("iddep", iddep);
                request.setAttribute("departement", dao.getDepartementByPK(iddep));
                request.setAttribute("liste_filieres", dao.getListeFilieres(iddep));
