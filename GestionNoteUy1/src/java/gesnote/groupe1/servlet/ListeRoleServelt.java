...
@WebServlet(name = "ListeRoleServelt", urlPatterns = {"/listerole"})
public class ListeRoleServelt extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("login") != null) {
            ...
            request.setAttribute("listeRole", dao.getListeRole());
