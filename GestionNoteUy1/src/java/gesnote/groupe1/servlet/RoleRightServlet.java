 ...
 * @author groupe 1
 */
@WebServlet(urlPatterns = {"/roleright"})
public class RoleRightServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("login") != null) {
            ...
            try {
                ...
                Droit droit = dao.getDroitByPK(id_droit);
                Role role = dao.getRoleByPK(id_role);
                List<Role> roles = droit.getRoleList();
                ...
                if (trouver) {
                    ...
                    jsonobject.put("resultat", "parfait".equals(dao.associateRoleRight(id_role, id_droit)) ? 1 : 0);
                }
